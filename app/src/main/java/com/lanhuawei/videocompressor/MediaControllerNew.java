...
public class MediaControllerNew extends FrameLayout {
    ...
    public MediaControllerNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = this;
        mFromXml = true;
    ...
    public MediaControllerNew(Context context, boolean isFromXml, View container) {
        super(context);
        initController(context);
        mFromXml = isFromXml;
    ...
    protected View makeControllerView() {
        return ((LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(getResources().getIdentifier("mediacontrollernew", "layout", mContext.getPackageName()), this);
    }

    private void initControllerView(View v) {
        mPauseButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontrollernew_play_pause", "id", mContext.getPackageName()));
        if (mPauseButton != null) {
            mPauseButton.requestFocus();
            mPauseButton.setOnClickListener(mPauseListener);
        }

        mProgress = (SeekBar) v.findViewById(getResources().getIdentifier("mediacontrollernew_seekbar", "id", mContext.getPackageName()));
        if (mProgress != null) {
        ...
        mEndTime = (TextView) v.findViewById(getResources().getIdentifier("mediacontrollernew_time_total", "id", mContext.getPackageName()));
        mCurrentTime = (TextView) v.findViewById(getResources().getIdentifier("mediacontrollernew_time_current", "id", mContext.getPackageName()));

        mFileName = (TextView) v.findViewById(getResources().getIdentifier("mediacontrollernew_file_name", "id", mContext.getPackageName()));
//    if (mFileName != null)
